...
public class MyAlert {
    ...
    private int anInt;
    private String namePromotionString, detailString, proceString, codeString;
    private int[] ints = new int[]{R.drawable.ais_logo, R.drawable.ais_logo, R.drawable.dtac_logo, R.drawable.true_logo};

    public MyAlert(Context context,
                   int anInt, String namePromotionString, String detailString, String proceString, String codeString) {
